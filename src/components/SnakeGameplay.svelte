<script lang="ts">
  ...
  import {ArrowUpSFillSYSTEM, ArrowDownSFillSYSTEM, ArrowLeftSFillSYSTEM, ArrowRightSFillSYSTEM} from 'svelte-remix'
...
<main class="main text-white flex flex-col items-start justify-center p-4 rounded bg-[#173735FF] w-[510px] mx-auto">
  <header>
    <div>
  ...
  <div class="screen-container flex flex-row items-end gap-6">
    ...
    <div class="w-48 h-36 px-3 py-4 flex flex-col justify-center rounded-lg bg-[#01142330]">
      ...
      <div class="buttons grid grid-cols-3 gap-1">
        <div />
        <button  on:click={() => changeDirection(DIRECTION.UP)} class="rounded-lg flex flex-row justify-center items-center bg-[#010C15] button"><ArrowUpSFillSYSTEM /></button>
        <div />
        <button on:click={() => changeDirection(DIRECTION.LEFT)} class="rounded-lg flex flex-row justify-center items-center bg-[#010C15] button"><ArrowLeftSFillSYSTEM /></button>
        <button on:click={() => changeDirection(DIRECTION.DOWN)} class="rounded-lg flex flex-row justify-center items-center bg-[#010C15] button"><ArrowDownSFillSYSTEM /></button>
        <button on:click={() => changeDirection(DIRECTION.RIGHT)} class="rounded-lg flex flex-row justify-center items-center bg-[#010C15] button"><ArrowRightSFillSYSTEM /></button>
      </div>
    </div>
  </div>
</main>
